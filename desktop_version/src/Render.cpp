...
static void menurender(void)
{
	...
	case Menu::start:
		...
		{
		case 0:
			graphics.bigprint(-1, 30, "Host world", tr, tg, tb, true);
			graphics.Print(-1, 65, "Host a world that others can join in.", tr, tg, tb, true);
			break;
		case 1:
			graphics.bigprint(-1, 30, "Join world", tr, tg, tb, true);
			graphics.Print(-1, 65, "Join others' host world.", tr, tg, tb, true);
			break;
		}
		break;
	case Menu::options:
