...
void Game::LoadTSave(const TSave &save)
{
	...
	savepoint = save.savepoint();
	companion = save.companion();
	lastsaved = save.lastsaved();
	teleportscript = save.teleportscript();
	supercrewmate = save.supercrewmate();
	scmprogress = save.scmprogress();
	frames = save.frames();
	seconds = save.seconds();
	minutes = save.minutes();
	hours = save.hours();
	deathcounts = save.deathcounts();
	...
	map.showtargets = save.showtargets();
...
std::string Game::writemaingamesave(tinyxml2::XMLDocument &doc)
{
	...
	xml::update_tag(msgs, "worldmap", os.str().c_str());
	os.clear();
	...
	xml::update_tag(msgs, "flags", os.str().c_str());
	os.clear();
	...
	xml::update_tag(msgs, "crewstats", os.str().c_str());
	os.clear();
	...
	xml::update_tag(msgs, "collect", os.str().c_str());
	os.clear();
