...
extern MessageEntityDefaultTypeInternal _MessageEntity_default_instance_;
class PlayerStatus;
...
class MessageEntity final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MessageEntity) */ {
 public:
  inline MessageEntity() : MessageEntity(nullptr) {}
  ~MessageEntity() override;
  explicit PROTOBUF_CONSTEXPR MessageEntity(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MessageEntity(const MessageEntity& from);
  MessageEntity(MessageEntity&& from) noexcept
    : MessageEntity() {
    *this = ::std::move(from);
  }

  inline MessageEntity& operator=(const MessageEntity& from) {
    CopyFrom(from);
    return *this;
  }
  inline MessageEntity& operator=(MessageEntity&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const MessageEntity& default_instance() {
    return *internal_default_instance();
  }
  static inline const MessageEntity* internal_default_instance() {
    return reinterpret_cast<const MessageEntity*>(
  ...
  inline void Swap(MessageEntity* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(MessageEntity* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  MessageEntity* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MessageEntity>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MessageEntity& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const MessageEntity& from) {
    MessageEntity::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MessageEntity* other);
  ...
  protected:
  explicit MessageEntity(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  public:
  void clear_tsave();
  const ::TSave& tsave() const;
  PROTOBUF_NODISCARD ::TSave* release_tsave();
  ::TSave* mutable_tsave();
  void set_allocated_tsave(::TSave* tsave);
  private:
  const ::TSave& _internal_tsave() const;
  ::TSave* _internal_mutable_tsave();
  public:
  void unsafe_arena_set_allocated_tsave(
      ::TSave* tsave);
  ...
  public:
  void clear_ps();
  const ::PlayerStatus& ps() const;
  PROTOBUF_NODISCARD ::PlayerStatus* release_ps();
  ::PlayerStatus* mutable_ps();
  void set_allocated_ps(::PlayerStatus* ps);
  private:
  const ::PlayerStatus& _internal_ps() const;
  ::PlayerStatus* _internal_mutable_ps();
  public:
  void unsafe_arena_set_allocated_ps(
      ::PlayerStatus* ps);
  ::PlayerStatus* unsafe_arena_release_ps();
...
// int64 id = 1;
inline void MessageEntity::clear_id() {
  _impl_.id_ = int64_t{0};
}
inline int64_t MessageEntity::_internal_id() const {
  return _impl_.id_;
}
inline int64_t MessageEntity::id() const {
  // @@protoc_insertion_point(field_get:MessageEntity.id)
  return _internal_id();
}
inline void MessageEntity::_internal_set_id(int64_t value) {
  
  _impl_.id_ = value;
}
inline void MessageEntity::set_id(int64_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:MessageEntity.id)
}

// .MessageType type = 2;
inline void MessageEntity::clear_type() {
  _impl_.type_ = 0;
}
inline ::MessageType MessageEntity::_internal_type() const {
  return static_cast< ::MessageType >(_impl_.type_);
}
inline ::MessageType MessageEntity::type() const {
  // @@protoc_insertion_point(field_get:MessageEntity.type)
  return _internal_type();
}
inline void MessageEntity::_internal_set_type(::MessageType value) {
  
  _impl_.type_ = value;
}
inline void MessageEntity::set_type(::MessageType value) {
...
inline bool MessageEntity::has_tsave() const {
  return _internal_has_tsave();
}
...
inline const ::TSave& MessageEntity::_internal_tsave() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::TSave&>(
      ::_TSave_default_instance_);
}
inline const ::TSave& MessageEntity::tsave() const {
  // @@protoc_insertion_point(field_get:MessageEntity.tsave)
  return _internal_tsave();
}
inline void MessageEntity::unsafe_arena_set_allocated_tsave(
    ::TSave* tsave) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.tsave_);
  }
  _impl_.tsave_ = tsave;
  if (tsave) {
    _impl_._has_bits_[0] |= 0x00000002u;
...
inline ::TSave* MessageEntity::_internal_mutable_tsave() {
  ...
  return _impl_.tsave_;
}
inline ::TSave* MessageEntity::mutable_tsave() {
  ::TSave* _msg = _internal_mutable_tsave();
  // @@protoc_insertion_point(field_mutable:MessageEntity.tsave)
  return _msg;
}
inline void MessageEntity::set_allocated_tsave(::TSave* tsave) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.tsave_;
  }
  if (tsave) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(tsave);
    if (message_arena != submessage_arena) {
...
inline bool MessageEntity::has_ps() const {
  return _internal_has_ps();
}
...
inline const ::PlayerStatus& MessageEntity::_internal_ps() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::PlayerStatus&>(
      ::_PlayerStatus_default_instance_);
}
inline const ::PlayerStatus& MessageEntity::ps() const {
  // @@protoc_insertion_point(field_get:MessageEntity.ps)
  return _internal_ps();
}
inline void MessageEntity::unsafe_arena_set_allocated_ps(
    ::PlayerStatus* ps) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.ps_);
  }
  _impl_.ps_ = ps;
  if (ps) {
    _impl_._has_bits_[0] |= 0x00000004u;
...
inline ::PlayerStatus* MessageEntity::mutable_ps() {
  ::PlayerStatus* _msg = _internal_mutable_ps();
  // @@protoc_insertion_point(field_mutable:MessageEntity.ps)
  return _msg;
}
inline void MessageEntity::set_allocated_ps(::PlayerStatus* ps) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.ps_;
  }
  if (ps) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(ps);
    if (message_arena != submessage_arena) {
